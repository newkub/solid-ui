...
export const validateSortDirection = (
	value: unknown,
): value is typeof sortDirectionSchema.infer => {
	const result = sortDirectionSchema(value);
	return !(result instanceof type.errors);
};

export const validateSortState = (
	value: unknown,
): value is typeof sortStateSchema.infer => {
	const result = sortStateSchema(value);
	return !(result instanceof type.errors);
};

export const validateSortableConfig = (
	value: unknown,
): value is typeof sortableConfigSchema.infer => {
...
export const validateFilterState = (
	value: unknown,
): value is typeof filterStateSchema.infer => {
	const result = filterStateSchema(value);
	return !(result instanceof type.errors);
};

export const validateFilterableConfig = (
	value: unknown,
): value is typeof filterableConfigSchema.infer => {
...
export const validateSelectionState = (
	value: unknown,
): value is typeof selectionStateSchema.infer => {
...
export const validatePaginationState = (
	value: unknown,
): value is typeof paginationStateSchema.infer => {
...
export const validatePaginationConfig = (
	value: unknown,
): value is typeof paginationConfigSchema.infer => {
	const result = paginationConfigSchema(value);
	return !(result instanceof type.errors);
};

export const validateRowState = (
	value: unknown,
): value is typeof rowStateSchema.infer => {
